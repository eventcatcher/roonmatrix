...
with_restserver_fastapi = is_app_embedded is False and use_fastapi is True
...
if startlog is True:
    ...
    flexprint('[bold deep_sky_blue4]with_restserver_fastapi: ' + str(with_restserver_fastapi) + '[/bold deep_sky_blue4]')
