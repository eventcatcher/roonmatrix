                        ...
                        return LayoutBuilder(
                          builder: (context, constraints) {
                            ...
                            return portraitMode
                                            ...
                                            builder: (context, constraints) {
                                              ...
                                              return Column(
                                                children: [
                                                  ...
                                                  // layout: portraitmode with swiper
                                                  if (showSwiper == true)
                                                    Container(
                                                      constraints:
                                                          coverWidth != null
                                                  ...
                                                  // layout: portraitmode without swiper
                                                  if (!showSwiper) ...[
                                                    Container(
                                                      constraints:
                                                          coverWidth != null
                                ...
                                : // layout: 2col or 3col mode
                                  Row(
                                    children: [
                                      // layout: 2col or 3col mode => part left
                                      windowWidth == null ||
                                              windowWidth! >
                                                  MediaQuery.of(
                                                        context,
                                      ...
                                      threeCols
                                          ?
                                            // layout: 3col mode => part middle
                                            threeColsWithoutSpace == true
                                                ?
                                                  // layout: 3col mode without space between
                                                  Flexible(
                                                    flex: 1,
                                                    child: LayoutBuilder(
                                                      builder: (context, constraints) {
                                                ...
                                                :
                                                  // layout: 3col mode with space between
                                                  LayoutBuilder(
                                                    builder: (context, constraints) {
                                                      if (kDebugMode) {
                                                        debugPrint(
                                                ...
                                                children: [
                                                  ...
                                                  if (!showSwiper ||
                                                      MediaQuery.of(
                                                          ...
                                                          swiperMinHeightLandscape)
                                                  // layout: 2col mode without swiper
                                                  ...[
                                                    Flexible(
                                                      child: LayoutBuilder(
                                                        builder: (context, constraints) {
