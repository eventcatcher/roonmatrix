...
class StartPageState extends State<StartPage> with TickerProviderStateMixin {
  ...
  void updateSizes(String caller) {
    ...
    showExportButton =
        (Globals.isMobileDevice() && orientation == Orientation.portrait) ||
      ...
      builder: (context, TranslationsState translationsState) {
        ...
        return BlocBuilder(
          ...
          builder: (context, SettingsState settingsState) {
            ...
            bool coverRowDynamicSize = settingsState.coverRowDynamicSize;
            ...
            bool miniPlayerAlwaysOnTop = settingsState.miniPlayerAlwaysOnTop;
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              ...
                              child: idle == true
                                  ...
                                  : mainState.disableListItemsRendering
                                  ? SizedBox()
                                  : ListView.separated(
                                      key: ValueKey(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        ...
                                        String scrollSpeedStandAloneKey =
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: DeviceListItem(
                                            ...
                                            scrollSpeedScrollMatrix:
                                                ...
                                                1.0,
                                            scrollSpeedDevice:
                                                scrollSpeedDeviceMap[scrollSpeedKey] ??
                                                scrollSpeedDevice,
                                            verticalTickerActive:
                                                verticalTickerActive,
                                            ledTickerInDeviceListActive:
