      ...
      child: Column(
        ...
        children: [
          ...
          MediaQuery.of(context).size.width > minIpFieldsInRowWidth
              ? Row(
                  children: [
                    Flexible(flex: 1, child: fromField()),
                    Flexible(flex: 1, child: toField()),
                  ],
                )
              : Column(children: [fromField(), toField()]),
          SizedBox(height: 8.0),
          Row(
            ...
            children: [
              StreamBuilder<String>(
                ...
                builder: (BuildContext context, AsyncSnapshot<String> snapshotStart) {
                                  ...
                                  children: [
                                    if (ipStart.text.isNotEmpty &&
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          translations['settingsIpRangeInvalidError'] ??
                                              'IP-Range is invalid',
          ...
          Padding(
            ...
            child: SwitchButton(
              label:
                  translations['moreInfoSelectorLabel'] ??
          ...
          Padding(
            ...
            child: SwitchButton(
              label:
                  translations['zonesCoverSelectorLabel'] ??
          ...
          Padding(
            ...
            child: Align(
              alignment: Alignment.topLeft,
              child: Text(
                translations['tickerHeadline'] ?? 'Ticker',
                textAlign: TextAlign.left,
                style: TextStyle(
                  fontSize: 14.0,
                  fontWeight: FontWeight.w400,
          ...
          Padding(
            ...
            child: SwitchButton(
              label:
                  translations['verticalTickerSelectorLabel'] ??
          ...
          Padding(
            ...
            child: SwitchButton(
              label:
                  translations['ledTickerInDeviceListSelectorLabel'] ??
                  'Display LED ticker in device list',
              enabled: ledTickerInDeviceListActive,
              onChanged: (value) {
                settingsBloc.setLedTickerInDeviceListActiveMode(enabled: value);
              },
            ),
          ),
          Padding(
            ...
            child: SwitchButton(
              label:
                  translations['ledTickerOnTickerPageSelectorLabel'] ??
                  'Display LED ticker on the ticker page',
              enabled: ledTickerOnTickerPageActive,
              onChanged: (value) {
                settingsBloc.setLedTickerOnTickerPageActiveMode(enabled: value);
              },
            ),
          ),
          Padding(
          ...
          Padding(
            ...
            child: SwitchButton(
              label:
                  translations['forceTickerUpdate'] ??
