    ...
    return PlatformMenuBar(
      menus: <PlatformMenuItem>[
        ...
        IPadEditMenu(
          ...
          onCut: () => editingService.cut(),
          onCopy: () => editingService.copy(),
          onPaste: () => editingService.paste(),
          onSelectAll: () => editingService.selectAll(),
          additionalItems: [],
        ),
        IPadViewMenu(
          additionalItems: sharedViewItems(
            context: context,
